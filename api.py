...
all_pms_data = [
  {
    "asi": {
      ...
      "Room Sold" : "Room Sold",
      "Guest Ledger Summary ClosingBalance": "Ending Guest Ledger",
      "Ledger Summary Guest Ledger": "Guest Ledger",
      "Ledger Summary Account Receivable Ledger": "Transfer to Direct Billing from Guest Ledger",
      "Account Receivable Ledger Summary ClosingBalance": "Ending City Ledger Net",
      "Ledger Summary Advance Deposit": "Advances transferred out",
      "Advance Deposit Summary ClosingBalance": "Ending Advance Deposit Ledger"
  ...
  "choiceadvantage": {
    ...
    "Transfer Into Guest Ledger": "transfers to direct billing from guest ledger",
    "Transfer To Accounts Receivable": "transfers to direct billing from guest ledger",
    "Other Revenue": "miscellaneous income",
    "Direct Bill (DB)": "City Ledger Net",
    "Direct Billing Receivable (DR)": "City Ledger Net",
    ...
    "Out Of Order": "Out of Order",
    "Guest Balance Forward": "Ending Guest Ledger",
    "Accounts Receivable Transfer To Accounts Receivable": "Transfer to Direct Billing from Guest Ledger",
    "Accounts Receivable Credits": "Payments Received Towards City Ledger",
    "Accounts Receivable Adjustments": "Payments Received Towards City Ledger",
    "Accounts Receivable Debits": "Transfer to Direct Billing from Guest Ledger",
    "Accounts Receivable Balance Forward": "Ending City Ledger Net",
    "Advance Deposit Advance Deposit Transferred Out": "Advances transferred out",
    "Advance Deposit Credits": "New Advances Received",
    "Advance Deposit Adjustments": "Advances transferred out",
    "Advance Deposit Debits": "Advances transferred out",
    "Advance Deposit Balance Forward": "Ending Advance Deposit Ledger"
    }
  },
  {
    "cloudbeds": {
 "comps": "Complimentary Rooms",
  ...
  },
  {
    ...
    "Guest Ledger Balance In House Net Change": "Guest Ledger",
    "Guest Ledger Balance In House Closing Balance": "Ending Guest Ledger",
    "Direct Bill Balance Direct Bill Net Change": "Transfer to Direct Billing from Guest Ledger",
    "Direct Bill Balance Direct Bill Closing Balance": "Ending City Ledger Net",
    "Guest Ledger Balance Group Master Net Change": "Group Ledger transferred out",
    "Guest Ledger Balance Group Master Ending Balance": "Ending Group Ledger Net",
    "Guest Ledger Balance House Account Net Change": "House Account transferred",
    "Guest Ledger Balance House Account Closing Balance": "Ending House Account Net",
    "Advanced Deposit Balance Group Master Net Change": "Group Master transferred",
    "Advanced Deposit Balance Group Master Closing Balance": "Ending Group Master Net",
    "Guest Ledger Balance Total Closed Folio Net Change": "Closed Folio",
    "Guest Ledger Balance Total Closed Folio Closing Balance": "Ending Closed Folio Net",
    "Advanced Deposit Balance Advance Deposit Net Change": "Advances transferred out",
    "Advanced Deposit Balance Advance Deposit Closing Balance": "Ending Advance Deposit Ledger"
    }
  },
  {
    "LightSpeed": {
      "Room Charge + Allowa": "misc. credit card payment",
  ...
  },
  {
    ...
    "SUITES/ROOMS OCCUPIED-TOTAL": "No need to map",
  ...
  "AR Ledger Charges and Transfers": "Transfer to Direct Billing from Guest Ledger",
  ...
  "Deposit Ledger Balance Today": "Ending Advance Deposit Ledger",
  ...
  "American Express": "amex rooms",
  "MasterCard": "visamc rooms",
  "Deposit Ledger Deposits Transfered at Check-In": "new advances received",
  "Deposit Ledger Payments": "advances transferred out",
  ...
  "Guest Ledger Charges": "guest ledger",
  "Guest Ledger Payments": "guest ledger",
  "Guest Ledger Deposits Transfered at Check-In": "guest ledger",
  "Complimentary Rooms": "complimentary rooms",
  ...
  },
  {
    "synixis": {
      ...
      "OOO Rooms": "out of order rooms",
      "Rooms Left Vacant": "vacant rooms",
      "MARTWA - Total" : "Restaurant",
      "1001 - Total": "rooms sales tax",
      "Guest Ledger Today Total": "Ending Guest Ledger",
      "Guest Ledger Difference": "Guest Ledger",
      "City Ledger Difference": "Transfer to Direct Billing from Guest Ledger",
      "City Ledger Today Total": "Ending City Ledger Net",
      ...
      "Company Ledger Difference": "Payments for Company Ledger",
      "Company Ledger Today Total": "Ending Company Ledger Net",
      "Advanced Deposit Ledger Difference": "Advances transferred out",
      "Advanced Deposit Ledger Today Total": "Ending Advance Deposit Ledger"
    }
  },
  {
    "visualmatrix": {
...
def get_openai_response(input_text: str = 'room rent', pms: str = 'AutoClerk'):
    for pms_data in all_pms_data:
        if pms in pms_data:
            pms_dict = pms_data[pms]
        else:
             f"{pms} is not found in the list"
    # prompt = f"Given a list of line items from Hotel PMS reports and a dictionary mapping line items to labels, ensure that each line item must have matched with a label from the dictionary. If a line item is not present in the dictionary, predict the most probable label from the entire dictionary for that new line item. Please do not give any explanation in the response instead return the line items(both new and exisiting) and their associated labels in JSON format:{json_string}.Here is the dictionary:{pms_dict}. Here is your input line items:"
    Prompt=f"You will be given a bunch of line items from Hotel PMS reports. You have to map every single line item to the correct label or category based on the below dictionary. If the line item is not present in the dictionary, you should predict the most probable label(value) in the dictionary that should be mapped with that new line item'.Ensure that you should check the number of input line items and the output you will be given should match. Please do not give any explanation in the response instead return the line items(both new and exisiting) and their associated labels in JSON format:{json_string}.Here is the dictionary:{pms_dict}. Here is your input line items:"
    
    prompt = f"You will be given hotel PMS reports consisting line items of daily sales. Your job is to map every line items from the line item list to the particular label based on the provided dictionary. If the line items are not present in the dictionary then you will map them to the most probable label(value) in the dictionary. Make sure to check the input line items will match with the output json items. Your response will be in JSON format only with no extra information{json_string}. Here is the dictionary:{pms_dict}. Here are your line items :"

    prompt2_gpt = prompt + input_text
    print(prompt2_gpt) 
